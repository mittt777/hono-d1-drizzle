...
--> statement-breakpoint
INSERT INTO `__new_posts`("id", "user_id", "title", "content", "created_at") SELECT "id", "user_id", "title", "content", "created_at" FROM `posts`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_users`("id", "email", "name", "created_at") SELECT "id", "email", "name", "created_at" FROM `users`;--> statement-breakpoint
